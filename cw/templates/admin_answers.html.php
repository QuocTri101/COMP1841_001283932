<section class="answer-box">
    ...
    <table class="answer-table">
            ...
            <?php foreach ($answers as $answer): ?>
                <tr>
                    ...
                    <td class="answer-actions">
                        <a href="editanswer.php?id=<?=htmlspecialchars($answer['id'], ENT_QUOTES, 'UTF-8');?>" class="btn edit-btn">Edit</a>

                        <a href="deleteanswer.php?id=<?=htmlspecialchars($answer['id'], ENT_QUOTES, 'UTF-8');?>"
        ...
        <?php else: ?>
            <tr>
                <td colspan="3" class="no-answer">No answers available for this question.</td>
            </tr>
        <?php endif; ?>
    </table>
</section>
...
<section class="answer-box">
    ...
    <form action="../admin/submit_answer.php" method="post">
